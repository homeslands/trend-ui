...
export default function ProgressBar({ step }: ProgressBarProps) {
  ...
  return (
    <ol className="flex items-center justify-center w-full py-6 space-x-2 text-sm font-medium text-center text-gray-500 rounded-lg dark:text-gray-400 sm:text-base dark:bg-transparent sm:space-x-4 rtl:space-x-reverse">
