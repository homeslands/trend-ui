...
interface GiftCardCountdownProps {
  createdAt: string | undefined
  setIsExpired: (value: boolean) => void
}

export function GiftCardCountdown({
  createdAt,
  setIsExpired,
}: GiftCardCountdownProps) {
  ...
  useEffect(() => {
    if (createdAt) {
      ...
      const remainingTime = orderExpirationTimeInSeconds - timePassed
