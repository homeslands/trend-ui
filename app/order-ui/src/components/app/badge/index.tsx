...
export { default as StaffPromotionTag } from './staff-promotion-tag'
export { default as NewProductTag } from './new-product-tag'
export { default as GiftCardStatusBadge } from './gift-card-status-badge'
export { default as LoyaltyPointTypeBadge } from './loyalty-point-type-badge'
export { default as TrendBadge } from './trend-badge'
