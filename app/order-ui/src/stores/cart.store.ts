  ...
  persist(
    (set, get) => ({
      ...
      addCartItem: (item: ICartItem) => {
        ...
        // Guard: không mix sản phẩm custom price với sản phẩm thường
        if (cartItems && cartItems.orderItems.length > 0) {
          const incomingIsCustom = item.orderItems.some((i) => i.isCustomPrice)
          const existingIsCustom = cartItems.orderItems.some((i) => i.isCustomPrice)
        ...
        set({
          cartItems: {
            ...
            voucher: {
              ...
              activeStartTime: voucher.activeStartTime ?? null,
              activeEndTime: voucher.activeEndTime ?? null,
              ...
              assignedUser: voucher.assignedUser || null,
              code: voucher.code,
              type: voucher.type,
