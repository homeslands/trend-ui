...
export default function NewsPage() {
  ...
  return (
    <div className="container py-6 flex flex-col gap-6">
      <h1 className="text-2xl sm:text-3xl font-bold text-primary text-center">Tin tức sự kiện</h1>
      ...
      <div className="w-full flex justify-center">
        ...
        >
          ...
          <CarouselPrevious className="hidden sm:flex top-[calc(50%-80px)]" />
          <CarouselNext className="hidden sm:flex top-[calc(50%-80px)]" />
        </Carousel>
      </div>
    </div>
  )
